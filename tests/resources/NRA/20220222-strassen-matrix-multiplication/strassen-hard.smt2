...
Generator: hand;
Application: Strassen-Matrix-Multiplication is an algorithm to do block 2x2 matrix multiplication using only 7 matrix multiplication. In this problem we try to derive all coefficients for this operation but already give the correct algebraic structure;
