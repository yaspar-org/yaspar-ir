...
(declare-fun ref () Int)
(assert (let ((?v_1 (>= (- s1_1 s2_1) 4)) (?v_0 (>= (- s2_1 s1_1) 4)) (?v_3 (>= (- s1_2 s2_2) 4)) (?v_2 (>= (- s2_2 s1_2) 4))) (and (or ?v_1 ?v_0) (or ?v_0 ?v_1) (or ?v_3 ?v_2) (or ?v_2 ?v_3) (>= (- s1_2 s1_1) 4) (>= (- s2_2 s2_1) 4) (<= (- s1_2 ref) 8) (<= (- s2_2 ref) 8) (>= (- s1_1 ref) 0) (>= (- s2_1 ref) 0))))
(check-sat)
(exit)
