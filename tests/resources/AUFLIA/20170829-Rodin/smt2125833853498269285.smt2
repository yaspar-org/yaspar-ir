                ...
                (and 
                    ...
                    (forall ((y49 Int)) 
                        (=> 
                            ...
                            (= y49 x2083)))))))
; Elementary Sets axiom (Singleton part)
(assert (forall ((x2084 Int) (x2085 A)) 
            (exists ((X2 PZA)) 
                (and 
                    (MS1 x2084 x2085 X2) 
               ...
               (=> 
                   ...
                   (exists ((x231 PZA)) 
                       (and 
                           ...
                           (path y20 y10 x231)))))
         :named hyp43))
(assert (! (forall ((x232 A) (y8 A) (p4 PZA) (i6 Int)) 
               (=> 
                   (and 
                       (MS0 x232 a) 
                       (MS0 y8 a) 
                               ...
                               (and 
                                   ...
                                   (forall ((x312 Int) (x313 A) (x314 A)) 
                                       (=> 
                                           ...
                                           (= x313 x314)))))))))
         :named hyp50))
(assert (! (forall ((x315 A) (y13 A) (p9 PZA) (i12 Int)) 
               (=> 
                   (and 
                       (MS0 x315 a) 
                       (MS0 y13 a) 
         ...
         :named hyp51))
(assert (! (forall ((x321 A) (y14 A) (p10 PZA) (i13 Int)) 
               (=> 
                   (and 
                       (MS0 x321 a) 
                       (MS0 y14 a) 
                       ...
                       (= 
                           ...
                           (or 
                               ...
                               (exists ((x628 Int)) 
                                   (MS1 x628 x624 s213)))))))
         :named hyp69))
(assert (! (forall ((s114 PZA) (s214 PZA) (i18 Int)) 
               (=> 
                   (and 
                       (exists ((n27 Int)) 
                           (and 
                       ...
                       (and 
                           ...
                           (exists ((x645 A)) 
                               (and 
                                   ...
                                   (MS1 i18 x645 x644)))))))
         :named hyp70))
(assert (! (forall ((s115 PZA) (s215 PZA) (i19 Int)) 
               (=> 
                   (and 
                       (exists ((n29 Int)) 
                           (and 
               ...
               (=> 
                   ...
                   (exists ((x710 PZA)) 
                       (and 
                           ...
                           (reverse x710 s42)))))
         :named hyp75))
(assert (! (forall ((x711 A) (y19 A) (p14 PZA) (i21 Int)) 
               (=> 
                   (and 
                       (MS0 x711 a) 
                       (MS0 y19 a) 
         ...
         :named hyp76))
(assert (! (forall ((x724 A) (y22 A) (p15 PZA) (i22 Int)) 
               (=> 
                   (and 
                       (MS0 x724 a) 
                       (MS0 y22 a) 
...
(assert (! (exists ((x808 Int)) 
               (and 
                   ...
                   (dist x y x808)))
         :named hyp83))
(assert (! (forall ((x809 A) (y26 A) (p19 PZA) (i24 Int)) 
               (=> 
                   (and 
                       (MS0 x809 a) 
                       (MS0 y26 a) 
                   ...
                   (and 
                       ...
                       (exists ((x823 A) (x824 Int)) 
                           (and 
                               ...
                               (dist x809 x823 x824))))))
         :named hyp84))
(assert (! (forall ((x828 A) (y27 A) (p20 PZA) (i25 Int)) 
               (=> 
                   (and 
                       (MS0 x828 a) 
                       (MS0 y27 a) 
...
(assert (! (forall ((s123 PZA) (s223 PZA)) 
         ...
         :named hyp91))
(assert (! (forall ((s124 PZA) (s224 PZA) (i42 Int)) 
               (=> 
                   (and 
                       (exists ((n63 Int)) 
                           (and 
                           ...
                           (and 
                               ...
                               (exists ((x1126 A)) 
                                   (and 
                                       ...
                                       (MS1 i42 x1126 s124))))))))
         :named hyp92))
(assert (! (forall ((s125 PZA) (s225 PZA) (i45 Int)) 
               (=> 
                   (and 
                       (exists ((n65 Int)) 
                           (and 
                       ...
                       (and 
                           ...
                           (forall ((x1523 Int) (x1524 A)) 
                               (= 
                                   ...
                                   (MS1 x1523 x1524 p29)))))))
         :named hyp104))
(assert (! (forall ((x1525 A) (y39 A) (p30 PZA) (i74 Int)) 
               (=> 
                   (and 
                       (MS0 x1525 a) 
                       (MS0 y39 a) 
               ...
               (=> 
                   ...
                   (exists ((x1628 A) (x1629 A)) 
                       (and 
                           ...
                           (MS x1628 x1629 r)))))
         :named hyp113))
(assert (! (forall ((x1631 A) (y42 A) (p32 PZA) (i80 Int)) 
               (=> 
                   (and 
                       (MS0 x1631 a) 
                       (MS0 y42 a) 
         ...
         :named hyp114))
(assert (! (forall ((x1689 A) (y43 A) (p33 PZA) (i83 Int)) 
               (=> 
                   (and 
                       (MS0 x1689 a) 
                       (MS0 y43 a) 
                           ...
                           (=> 
                               ...
                               (exists ((x2043 A) (x2044 A)) 
                                   (and 
                                       ...
                                       (MS x2043 x2044 r))))))))
         :named hyp119))
(assert (! (exists ((x2053 A) (x2054 Int)) 
               (and 
                   (exists ((x2055 Int)) 
                       (and 
                           (= x2055 1) 
                   ...
                   (dist x2053 y x2054)))
         :named hyp120))
(assert (! (exists ((x2056 A) (x2057 A) (x2058 Int)) 
               (and 
                   (exists ((x2059 Int)) 
                       (and 
                           (= x2059 1) 
                   ...
                   (exists ((x2060 Int)) 
                       (and 
                           ...
                           (MS1 x2060 x2057 p))) 
                   (length p x2058) 
                   (dist x2056 x2057 x2058)))
         :named hyp121))
(assert (! (not 
               (exists ((n102 Int)) 
                   (and 
                       (<= 0 n102) 
                       (forall ((x2061 Int) (x2062 A)) 
                           (=> 
                               (exists ((i141 Int)) 
                                   (and 
                                       (<= 1 i141) 
                               ...
                               (and 
                                   (<= 1 x2061) 
                                   (<= x2061 n102)))) 
                       (forall ((x2066 Int) (x2067 A) (x2068 A)) 
                           (=> 
                               (and 
                                   (exists ((i142 Int)) 
                                       (and 
